...
namespace PropagatingKindness.Infra.Migrations
{
    ...
    [Migration("20241230164637_AddingPropertyCoverImageToBlog")]
    partial class AddingPropertyCoverImageToBlog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropagatingKindness.Domain.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PropagatingKindness.Domain.Models.Chat", b =>
                {
                    b.HasOne("PropagatingKindness.Domain.Models.Advert", "Advert")
                        .WithMany()
                        .HasForeignKey("AdvertId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PropagatingKindness.Domain.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PropagatingKindness.Domain.Models.User", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PropagatingKindness.Domain.Models.Message", b =>
                {
                    b.HasOne("PropagatingKindness.Domain.Models.Chat", "Chat")
                        .WithMany("Messages")
